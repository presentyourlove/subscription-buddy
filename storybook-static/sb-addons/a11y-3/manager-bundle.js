    ...
    var H = { VIOLATION: 'violations', PASS: 'passes', INCOMPLETION: 'incomplete' },
      ...
      rr = (e) => {
        ...
        let T = E(() => {
          ...
          W = E(async (m) => {
            let { createCopyToClipboardFunction: b } = await Promise.resolve().then(() => (K(), ct))
            ...
            P(
              ...
              l,
              {
                ...
                onMouseDown: X(e.onMouseDown, (y) => {
                  !i && y.button === 0 && y.ctrlKey === !1 ? o.onValueChange(n) : y.preventDefault()
                }),
      ...
      fo = () => {
        let [e, t] = L(null),
          a = uo.map(({ name: n, percentage: i }) => {
            ...
            return { title: n, description: l, icon: r.createElement(po, { $filter: n }), value: n }
          })
        return r.createElement(
          r.Fragment,
          null,
