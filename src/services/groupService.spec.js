...
describe('GroupService', () => {
    ...
    describe('createGroup', () => {
        it('should create a group', async () => {
            ...
            vi.mocked(firestore.addDoc).mockResolvedValue({ id: 'new-group-id' });
            await groupService.createGroup(mockData, mockUser);
    ...
    describe('getGroups', () => {
        it('should fetch open groups', async () => {
            ...
            vi.mocked(firestore.getDocs).mockResolvedValue({ docs: mockDocs });
...
//# sourceMappingURL=groupService.spec.js.map