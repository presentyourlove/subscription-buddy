...
if (__VLS_ctx.userStore.user) {
    ...
    for (const [msg] of __VLS_vFor((__VLS_ctx.chatStore.messages))) {
        ...
        // @ts-ignore
        [userStore, userStore, userStore, userStore, $t, $t, $t, $t, $t, isDealClosed, isDealClosed, hasConfirmed, handleConfirm, chatStore, chatStore, formatTime,];
    }
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.input)({
        ...
        placeholder: (__VLS_ctx.isDealClosed ? __VLS_ctx.$t('chat.inputClosed') : __VLS_ctx.$t('chat.inputPlaceholder')),
    });
    /** @type {__VLS_StyleScopedClasses['flex-1']} */ ;
    ...
    if (__VLS_ctx.isDealClosed) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    // @ts-ignore
                    [$t, $t, isDealClosed, isDealClosed, isDealClosed, isDealClosed, handleSend, newMessage, newMessage, showRatingModal,];
                } },
    ...
    if (__VLS_ctx.showRatingModal) {
        ...
        /** @type {__VLS_StyleScopedClasses['overflow-y-auto']} */ ;
        for (const [p] of __VLS_vFor((__VLS_ctx.participantsInfo))) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
                key: (p.uid),
            ...
            if (__VLS_ctx.checkRated(p.uid)) {
                ...
                /** @type {__VLS_StyleScopedClasses['gap-2']} */ ;
                /** @type {__VLS_StyleScopedClasses['mb-3']} */ ;
                for (const [n] of __VLS_vFor((__VLS_ctx.maxRating))) {
                    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                        ...{ onClick: (...[$event]) => {
                                if (!(__VLS_ctx.userStore.user))
                                    return;
                        ...
                        ...{ class: ((__VLS_ctx.ratingTarget?.uid === p.uid ? __VLS_ctx.ratingScore : 0) >= n
                                ? 'text-yellow-400'
                                : 'text-gray-600') },
                    });
                ...
                if (__VLS_ctx.ratingTarget?.uid === p.uid) {
                    ...
                    // @ts-ignore
                    [$t, $t, ratingTarget, ratingTarget, ratingScore, ratingComment, ratingComment, handleRate,];
                    var __VLS_14;
                    var __VLS_15;
                }
            }
    ...
    /** @type {__VLS_StyleScopedClasses['justify-center']} */ ;
    /** @type {__VLS_StyleScopedClasses['text-gray-400']} */ ;
    (__VLS_ctx.$t('chat.loginRequired'));
}
// @ts-ignore
