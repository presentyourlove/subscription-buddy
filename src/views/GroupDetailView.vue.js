...
const { data: group } = useFirestoreDoc('groups', groupId);
...
const handleDelete = async () => {
    if (!confirm(t('group.detail.confirmDelete')))
        return;
    ...
    try {
        ...
        notification.error(t('group.error.deleteFailed') + ': ' + err.message);
    }
};
const handleCloseGroup = async () => {
    if (!confirm(t('group.detail.confirmClose')))
        return;
    if (!group.value || !group.value.id)
        return;
    try {
        ...
        notification.error(t('group.error.closeFailed') + ': ' + err.message);
    }
};
const __VLS_ctx = {
    ...{},
...
if (__VLS_ctx.group) {
    ...
    (__VLS_ctx.group.title);
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
        ...{ class: "px-3 py-1 text-sm rounded-full border" },
        ...{ class: ({
                'bg-green-500/20 text-green-300 border-green-500/30': __VLS_ctx.group.status === __VLS_ctx.GROUP_STATUS.OPEN,
                'bg-gray-500/20 text-gray-300 border-gray-500/30': __VLS_ctx.group.status === __VLS_ctx.GROUP_STATUS.CLOSED,
                'bg-red-500/20 text-red-300 border-red-500/30': __VLS_ctx.group.status === __VLS_ctx.GROUP_STATUS.FULL
            }) },
    });
    ...
    (__VLS_ctx.$t(`group.status.${__VLS_ctx.group.status}`));
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...
    if (__VLS_ctx.isHost) {
        ...
        if (__VLS_ctx.group.status !== __VLS_ctx.GROUP_STATUS.CLOSED) {
            ...
            /** @type {__VLS_StyleScopedClasses['hover:bg-gray-500/20']} */ ;
            /** @type {__VLS_StyleScopedClasses['text-gray-400']} */ ;
            /** @type {__VLS_StyleScopedClasses['border']} */ ;
            /** @type {__VLS_StyleScopedClasses['border-gray-500/20']} */ ;
            /** @type {__VLS_StyleScopedClasses['rounded-lg']} */ ;
            /** @type {__VLS_StyleScopedClasses['transition-colors']} */ ;
            /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
            /** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
            (__VLS_ctx.$t('group.detail.manualClose'));
        }
        if (__VLS_ctx.group.status !== __VLS_ctx.GROUP_STATUS.CLOSED) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...
            /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
            /** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
            (__VLS_ctx.$t('group.detail.deleteGroup'));
        }
    }
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...
    (__VLS_ctx.$t('group.detail.pricePerMonth'));
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...
    /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
    /** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
    (__VLS_ctx.$t('group.detail.slotsLeft'));
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...
    /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
    /** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
    (__VLS_ctx.$t('group.detail.paymentMethod'));
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...
    /** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
    /** @type {__VLS_StyleScopedClasses['text-gray-300']} */ ;
    (__VLS_ctx.$t('group.detail.paymentMethodValue'));
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "mb-8" },
    });
    /** @type {__VLS_StyleScopedClasses['mb-8']} */ ;
    ...
    (__VLS_ctx.$t('group.detail.description'));
    ...
    /** @type {__VLS_StyleScopedClasses['border-white/10']} */ ;
    if (__VLS_ctx.isHost || __VLS_ctx.group.status === __VLS_ctx.GROUP_STATUS.CLOSED) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...
        (__VLS_ctx.isHost ? __VLS_ctx.$t('group.detail.hostRole') : __VLS_ctx.$t('group.detail.closedRole'));
        // @ts-ignore
        [group, group, group, group, group, group, group, group, group, group, group, group, group, group, group, $t, $t, $t, $t, $t, $t, $t, $t, $t, $t, $t, $t, $t, $t, $t, GROUP_STATUS, GROUP_STATUS, GROUP_STATUS, GROUP_STATUS, GROUP_STATUS, GROUP_STATUS, formatDate, isHost, isHost, isHost, handleCloseGroup, handleDelete,];
        var __VLS_14;
        if (__VLS_ctx.isHost) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...
            /** @type {__VLS_StyleScopedClasses['text-gray-400']} */ ;
            /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
            (__VLS_ctx.$t('group.detail.hostHint'));
        }
    }
    else {
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
    ...
    /** @type {__VLS_StyleScopedClasses['text-gray-500']} */ ;
    (__VLS_ctx.$t('group.detail.loading'));
}
// @ts-ignore
[$t, $t,];
