...
/** @type {__VLS_StyleScopedClasses['max-w-2xl']} */ /** @type {__VLS_StyleScopedClasses['mx-auto']} */ /** @type {__VLS_StyleScopedClasses['px-4']} */ /** @type {__VLS_StyleScopedClasses['py-8']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div
)({
...
/** @type {__VLS_StyleScopedClasses['bg-white/5']} */ /** @type {__VLS_StyleScopedClasses['backdrop-blur-md']} */ /** @type {__VLS_StyleScopedClasses['border']} */ /** @type {__VLS_StyleScopedClasses['border-white/10']} */ /** @type {__VLS_StyleScopedClasses['rounded-2xl']} */ /** @type {__VLS_StyleScopedClasses['p-8']} */ /** @type {__VLS_StyleScopedClasses['shadow-xl']} */ __VLS_asFunctionalElement1(
  ...
  ...{
    class:
      'text-3xl font-bold mb-8 bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent'
  }
})
/** @type {__VLS_StyleScopedClasses['text-3xl']} */ /** @type {__VLS_StyleScopedClasses['font-bold']} */ /** @type {__VLS_StyleScopedClasses['mb-8']} */ /** @type {__VLS_StyleScopedClasses['bg-gradient-to-r']} */ /** @type {__VLS_StyleScopedClasses['from-purple-400']} */ /** @type {__VLS_StyleScopedClasses['to-pink-500']} */ /** @type {__VLS_StyleScopedClasses['bg-clip-text']} */ /** @type {__VLS_StyleScopedClasses['text-transparent']} */ __VLS_ctx.$t(
  'create.title'
)
__VLS_asFunctionalElement1(
...
/** @type {__VLS_StyleScopedClasses['space-y-6']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div
)({})
...
/** @type {__VLS_StyleScopedClasses['grid']} */ /** @type {__VLS_StyleScopedClasses['grid-cols-2']} */ /** @type {__VLS_StyleScopedClasses['gap-6']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div
)({})
...
/** @type {__VLS_StyleScopedClasses['pt-4']} */ const __VLS_22 = BaseButton || BaseButton
// @ts-ignore
const __VLS_23 = __VLS_asFunctionalComponent1(
  __VLS_22,
  new __VLS_22({
    type: 'submit',
...
if (__VLS_ctx.groupStore.error) {
  ...
  /** @type {__VLS_StyleScopedClasses['text-red-400']} */ /** @type {__VLS_StyleScopedClasses['text-center']} */ /** @type {__VLS_StyleScopedClasses['text-sm']} */ __VLS_ctx
    .groupStore.error
}
// @ts-ignore
