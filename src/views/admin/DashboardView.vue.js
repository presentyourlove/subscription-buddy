...
/** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
(__VLS_ctx.$t('admin.stats.fromLastMonth'));
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "bg-white p-6 rounded-lg shadow-sm border border-gray-100" },
});
/** @type {__VLS_StyleScopedClasses['bg-white']} */ ;
...
/** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
/** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
(__VLS_ctx.$t('admin.activeGroups'));
__VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)({
    ...{ class: "text-3xl font-bold text-gray-800 mt-2" },
});
/** @type {__VLS_StyleScopedClasses['text-3xl']} */ ;
...
/** @type {__VLS_StyleScopedClasses['text-green-500']} */ ;
/** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
(__VLS_ctx.$t('admin.stats.newToday'));
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "bg-white p-6 rounded-lg shadow-sm border border-gray-100" },
});
/** @type {__VLS_StyleScopedClasses['bg-white']} */ ;
...
/** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
/** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
(__VLS_ctx.$t('admin.pendingReports'));
__VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)({
...
/** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
(__VLS_ctx.$t('admin.stats.needsAttention'));
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
...
(__VLS_ctx.$t('admin.systemAlerts'));
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "p-4 bg-blue-50 text-blue-700 rounded-md" },
});
